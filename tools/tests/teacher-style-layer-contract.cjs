...
const version = '20260812v813RoleWorkspacesP0';
const expected = [
...
assert.equal(
  ...
  '8df9e999adc053e1ebdd39c8f50e29490ba74d62e49c09f5a0cebf6c3e5877ef',
  'teacher style layers must preserve the reviewed UI-006 showcase-story cascade byte order',
);
