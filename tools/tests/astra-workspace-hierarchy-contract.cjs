...
assert.match(html, /shared\/js\/router\.js\?v=20260812v822PublicationSingleflightP0/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260812v822PublicationSingleflightP0/);
