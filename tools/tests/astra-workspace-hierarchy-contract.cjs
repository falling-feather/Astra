...
assert.match(html, /shared\/js\/router\.js\?v=20260825v840TeacherApplicationP0/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260825v840TeacherApplicationP0/);
