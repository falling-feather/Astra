...
assert.match(html, /shared\/js\/router\.js\?v=20260828v861PresentationCleanupP3/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260828v861PresentationCleanupP3/);
