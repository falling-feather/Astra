...
assert.match(html, /shared\/js\/router\.js\?v=20260828v863CourseHealthMatrixP0/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260828v863CourseHealthMatrixP0/);
