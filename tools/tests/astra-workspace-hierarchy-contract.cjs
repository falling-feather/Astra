...
assert.match(html, /shared\/js\/router\.js\?v=20260828v854ManagementShowcaseP0/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260828v854ManagementShowcaseP0/);
