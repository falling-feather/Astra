...
assert.match(html, /shared\/js\/router\.js\?v=20260731v7960AdminRegistryEntryP0/);
...
assert.match(serviceWorker, /shared\/js\/router\.js\?v=20260731v7960AdminRegistryEntryP0/);
