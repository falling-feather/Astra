...
assert.match(serviceWorker, /experiment-registry\.js\?v=20260812v822PublicationSingleflightP0/);
assert.match(serviceWorker, /astra-static-v20260812v822PublicationSingleflightP0/);
