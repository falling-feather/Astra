...
assert.match(
  html,
  /experiment-registry\.js\?v=20260824v832Show03P0[\s\S]*learning-activity-catalog\.js\?v=20260825v834Show04P0[\s\S]*public-guide\.js\?v=20260824v816ExperimentRestoreP2[\s\S]*app-session\.js\?v=20260828v864RoleWorkbenchHarmonyP0/,
