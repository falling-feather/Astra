...
assert.match(authoringSource, /COURSE_CONTENT_VERSION = '20260828v864RoleWorkbenchHarmonyP0'/);
...
assert.match(registrySource, /TEACHER_RESOURCE_VERSION = '20260828v864RoleWorkbenchHarmonyP0'/);
