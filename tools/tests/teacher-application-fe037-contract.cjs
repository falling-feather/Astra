...
assert.match(admin, /ADMIN_ASSET_VERSION = '20260828v864RoleWorkbenchHarmonyP0'/);
assert.match(registry, /ADMIN_RESOURCE_VERSION = '20260828v864RoleWorkbenchHarmonyP0'/);
