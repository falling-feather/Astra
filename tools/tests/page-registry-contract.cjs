...
assert.equal(registry.scriptFor('student'), 'pages/student/student-workbench.js?v=20260812v817RoleFeedbackP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260812v826PhysicsBindOrderP0/);
