...
assert.equal(registry.scriptFor('planets'), 'pages/planets/planets.js?v=20260731v7968StudentFlowP2');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260731v7968StudentFlowP2/);
...
assert.match(router, /module-selector\.js\?v=20260731v7968StudentFlowP2/);
assert.match(main, /module-selector\.js\?v=20260731v7968StudentFlowP2/);
