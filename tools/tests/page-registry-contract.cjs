...
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260828v854ManagementShowcaseP0');
assert.equal(registry.scriptFor('engineering'), 'pages/engineering/engineering-page.js?v=20260825v834Show04P0');
assert.equal(registry.scriptFor('planets'), 'pages/planets/planets.js?v=20260828v854ManagementShowcaseP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260828v854ManagementShowcaseP0/);
