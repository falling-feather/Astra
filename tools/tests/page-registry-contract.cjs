...
assert.equal(registry.scriptFor('student'), 'pages/student/student-workbench.js?v=20260813v832RoleMobileReceiptP0');
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260813v832RoleMobileReceiptP0');
assert.equal(registry.scriptFor('engineering'), 'shared/js/frontier-learning.js?v=20260813v833LoadPathSameFrameP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260813v834ShowcaseLayoutP0/);
