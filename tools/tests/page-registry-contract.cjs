...
assert.equal(registry.scriptFor('student'), 'pages/student/student-workbench.js?v=20260812v828RoleStoryP0');
assert.equal(registry.scriptFor('teacher'), 'pages/teacher/teacher.js?v=20260812v828RoleStoryP0');
assert.equal(registry.scriptFor('engineering'), 'shared/js/frontier-learning.js?v=20260812v829FlagshipStoryP0');
...
assert.match(serviceWorker, /page-registry\.js\?v=20260812v830ShowcaseStoryP0/);
...
assert.match(router, /module-selector\.js\?v=20260812v825PhysicsBindOrderP0/);
assert.match(main, /module-selector\.js\?v=20260812v825PhysicsBindOrderP0/);
