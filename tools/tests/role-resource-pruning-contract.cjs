...
const studentVersion = '20260731v7969StudentUiP0';
const teacherVersion = '20260730v785TeacherNaturalWorkflowP0';
...
assert.match(serviceWorker, /astra-static-v20260731v7971CatalogueCountP0/);
