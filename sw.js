const CACHE_NAME = 'astra-static-v20260825v834Show04P0';
const APP_SHELL = [
  './',
  './index.html',
  './shared/js/lucide.min.js?v=20260417d',
  './shared/js/config.js?v=20260825v834Show04P0',
  './shared/js/api-client.js?v=20260719v7437AstraWorkspaceP0',
  './shared/js/auth-ui.js?v=20260716v7427RoleWorkflowGateP0',
  './shared/js/app-session.js?v=20260824v816ExperimentRestoreP2', './shared/js/experiment-registry.js?v=20260824v816ExperimentRestoreP2',
  './shared/js/page-registry.js?v=20260825v834Show04P0', './shared/js/router.js?v=20260824v816ExperimentRestoreP2',
  './shared/js/main.js?v=20260825v834Show04P0',
