...
import { e, selectField } from './presentation';
import { resourcePreviewMarkup } from './resource-preview';
import { templateFields, readTemplateForm } from './template-controls';
...
export class ResourceStudio {
  ...
  private fields(): string {
    return templateFields(this.selected!.renderer, this.configuration);
  }
  ...
  private readForm(): TemplateConfiguration {
    ...
    return readTemplateForm(this.selected.renderer, this.configuration, new FormData(form));
  }
