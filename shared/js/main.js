...
const SHELL_RUNTIME_ASSET_VERSION = '20260812v822PublicationSingleflightP0';
const PAGE_REGISTRY_ASSET_VERSION = '20260812v822PublicationSingleflightP0';
...
const GALAXY_HTTP_FALLBACK_ASSETS = {
    ...
    englab: [
        ...
        './shared/js/module-selector.js?v=20260812v819PhysicsFirstLoadP0',
