...
FE-012 / V7.7.22 已集成；专业组保留在 `C:/Users/niu-h/.codex/worktrees/d6b6/工科实验室 / codex/fe-v7.7-evidence-a03a-unit-access @ 5db1112e`，工作树 clean、写入关闭。下一动作只由 QA-014 / V7.7.24 在主开发精确集成 SHA 上独立复验；产品失败仍退回原 FE-012，环境阻断只记 NOT-RUN，不创建竞争任务。

QA-014 / V7.7.23 已在 `C:/Users/niu-h/.codex/worktrees/c91f/工科实验室` detached @ `9d4081bd93176b5764d73a6af1af64e44bfb57df` 以 BLOCKED / NOT-RUN 收口；保留 TEMP `C:/Users/niu-h/AppData/Local/Temp/astra-qa-v7723-a3cf704d512d4b57aec5792b2e68876f`，不得重试删除、移动或复用。V7.7.24 继续复用 clean 的 c91f 与相同产品 SHA，但使用全新唯一 TEMP，并从创建时把空 `data/`、`scratch/` 与 `evidence/` 分离；仓库内仍不写运行产物。旧 `89e8@46b27a1` 不移动，`a02c` 永久禁入。
...
2. 项目对接模式已经启用。CONTENT、FE、BE、QA 已按标准标题恢复并登记独立 worktree；CONTENT 与 QA 只读，写入组只在收到主开发的精确任务 / 版本 / 文件包后写各自物理目录。BE-007、BE-011、DATA-002 与 FE-012 / V7.7.22 已完成当前增量；FE、BE、DATA、UI 写入均已关闭。QA-014 复用唯一长期任务：V7.7.23 已按平台阻断规则收口，V7.7.24 在同一 clean detached `c91f@9d4081b` 上以 data / scratch 永久分离的全新运行包继续 A03a。同一任务只设一个主责组，产品失败仍退回原 FE-012。
...
- `主开发` 及其任务分支使用 `Vx.y.z GROUP type(scope): 中文说明（TASK-ID）`；版本由 02 唯一分配。`V7.6.6`、`V7.6.7`、`V7.6.11`、`V7.6.12` 均为已取消的空预留，不得复用；`V7.6.15—16` 只属于 `PM-015`，`V7.7.0` 只属于 `CONTENT-003`，`V7.7.1—2`、`V7.7.6`、`V7.7.8`、`V7.7.10`、`V7.7.12`、`V7.7.17`、`V7.7.19` 与 `V7.7.22` 只属于 `FE-012`，`V7.7.3` 只属于 `FE-017` 的视觉规格提案而非产品实现，`V7.7.4` 只属于 `TOOLS-001`，`V7.7.5`、`V7.7.7`、`V7.7.9`、`V7.7.11`、`V7.7.16`、`V7.7.18`、`V7.7.20`、`V7.7.21`、`V7.7.23` 与 `V7.7.24` 只属于 `QA-014 A03a`；`V7.7.21` 仅补录旧最终回执，`V7.7.23` 记录平台 BLOCKED，`V7.7.24` 只用于 data / scratch 分离后的完整复验；`V7.8.0` 已由 `BE-007` 使用，`V7.8.2` 已由 `BE-011` 使用，均不得复用。
