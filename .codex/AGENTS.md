...
FE-012 / V7.7.22 已集成；专业组保留在 `C:/Users/niu-h/.codex/worktrees/d6b6/工科实验室 / codex/fe-v7.7-evidence-a03a-unit-access @ 5db1112e`，工作树 clean、写入关闭。QA-014 / V7.7.24 已因本机启动脚本必须写仓库 `.venv` 而 NOT-RUN；FE-012 不接受环境阻断返修，继续等待唯一工具任务完成后由 QA 复验。
...
2. 项目对接模式已经启用。CONTENT、FE、BE、QA 已按标准标题恢复并登记独立 worktree；CONTENT 与 QA 只读，写入组只在收到主开发的精确任务 / 版本 / 文件包后写各自物理目录。BE-007、BE-011、DATA-002 与 FE-012 / V7.7.22 已完成当前增量；FE、BE、DATA、UI 写入均已关闭。QA-014 复用唯一长期任务，V7.7.23—24 均已按环境阻断规则收口，当前暂缓等待主开发另建唯一启动工具任务；不得把该阻断退回 FE 或建立竞争 QA 任务。
...
- `主开发` 及其任务分支使用 `Vx.y.z GROUP type(scope): 中文说明（TASK-ID）`；版本由 02 唯一分配。`V7.6.6`、`V7.6.7`、`V7.6.11`、`V7.6.12` 均为已取消的空预留，不得复用；`V7.6.15—16` 只属于 `PM-015`，`V7.7.0` 只属于 `CONTENT-003`，`V7.7.1—2`、`V7.7.6`、`V7.7.8`、`V7.7.10`、`V7.7.12`、`V7.7.17`、`V7.7.19` 与 `V7.7.22` 只属于 `FE-012`，`V7.7.3` 只属于 `FE-017` 的视觉规格提案而非产品实现，`V7.7.4` 只属于 `TOOLS-001`，`V7.7.5`、`V7.7.7`、`V7.7.9`、`V7.7.11`、`V7.7.16`、`V7.7.18`、`V7.7.20`、`V7.7.21`、`V7.7.23` 与 `V7.7.24` 只属于 `QA-014 A03a`；`V7.7.21` 仅补录旧最终回执，`V7.7.23` 记录缓存清理平台阻断，`V7.7.24` 记录 strict-readonly `.venv` 启动阻断；后续工具与 QA 版本必须重新查重分配；`V7.8.0` 已由 `BE-007` 使用，`V7.8.2` 已由 `BE-011` 使用，均不得复用。
