...
2. 项目对接模式已经启用。CONTENT、FE、BE、QA 已按标准标题恢复；QA 只读，写入组只在收到主开发的精确任务 / 版本 / 文件包后写各自物理目录。CONTENT-004 / V7.8.3、DATA-003 / V7.9.19 与 BE-013 / V7.8.4 均已完成并暂停。QA-013 / V7.8.6 已 RETURN FE-013 并释放 Browser / 9001；qe13 与唯一 TEMP 只读保留。FE-012 的 fz30 已提交 `30f7f189` 并关闭写入；QA-014 / V7.7.31 的 qz31 只读运行包另行收束。FE-013 / V7.8.7 已由 ft87 提交 `15c0e831`、独立复审 PASS 并进入集成线，ft87 clean 且写入关闭；真实运行复验仍须新 QA 包。q28a、c04e、da03、be13、fe13、qe13、qz31、ft87、fz30 与外部证据各守任务边界。原长期任务处于 systemError 时，只允许主开发登记的边界明确临时执行者接续同一任务编号，不创建竞争任务标题；不得复用旧 d6b6 / f27a / b56e。
