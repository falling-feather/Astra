...
FE-012 / V7.7.22 已集成；专业组保留在 `C:/Users/niu-h/.codex/worktrees/d6b6/工科实验室 / codex/fe-v7.7-evidence-a03a-unit-access @ 5db1112e`，工作树 clean、写入关闭。QA-014 / V7.7.24 已因旧本机启动脚本必须写仓库 `.venv` 而 NOT-RUN；FE-012 不接受环境阻断返修。TOOLS-002 / V7.7.25 已完成并集成，同一 QA-014 现于新 detached `b56e@de3afdbf` 使用已分配的 V7.7.26 复验。

QA-014 / V7.7.23 与 V7.7.24 均已在 `C:/Users/niu-h/.codex/worktrees/c91f/工科实验室` detached @ `9d4081bd93176b5764d73a6af1af64e44bfb57df` 以 BLOCKED / NOT-RUN 收口；分别保留 TEMP `C:/Users/niu-h/AppData/Local/Temp/astra-qa-v7723-a3cf704d512d4b57aec5792b2e68876f` 与 `C:/Users/niu-h/AppData/Local/Temp/astra-qa-v7724-8675d4a5dae84c1182f6793c5ec26d0d`，不得删除、移动、复用或改写证据。V7.7.24 的 data 最终精确为空，c91f 无 `.venv` 且保持 clean。V7.7.26 新树为 `C:/Users/niu-h/.codex/worktrees/b56e/工科实验室 @ de3afdbf6934ec4e321bce75fa0595df0c67fed6`，detached、clean、无 `.venv`；QA 已恢复。旧 `89e8@46b27a1` 不移动，`a02c` 永久禁入。
...
2. 项目对接模式已经启用。CONTENT、FE、BE、QA 已按标准标题恢复并登记独立 worktree；CONTENT 与 QA 只读，写入组只在收到主开发的精确任务 / 版本 / 文件包后写各自物理目录。BE-007、BE-011、DATA-002、FE-012 / V7.7.22 与 TOOLS-002 / V7.7.25 已完成当前增量；FE、BE、DATA、UI、TOOLS 写入均已关闭。QA-014 复用唯一长期任务，现于新 detached `b56e@de3afdbf` 以 V7.7.26 完整复验；不得把既有环境阻断退回 FE、复用旧 c91f 或建立竞争 QA 任务。
...
9. 未来星系层级重构以 `doc/02-项目规划.md` 第 1.4 节、`doc/02-子文档/25-V7.7未来星系18课程内容与路由冻结矩阵.md`、`doc/02-子文档/26-V7.7未来星系页面视觉规格.md`、`FE-017`、`QA-015` 为唯一规划入口。18 门课程全部保留，CONTENT-003 已完成，FE-012 首批共享接口与多轮 A03a 返修已形成集成基线；V7.7.20 证明真实学生单元列表过滤 hidden，BE-011 与 V7.7.22 已分别完成有界精确处置及其前端接线 / 固定诊断 / Zoom 打开态 resize。V7.7.23—24 只形成静态 PASS 与两次环境 BLOCKED，不构成产品判断；V7.7.25 已解除 strict-readonly 启动工具门禁，同一 QA-014 / V7.7.26 现于全新 detached `b56e` 工作树执行真实复验。26 号视觉规格仍待用户确认，之后必须生成并再次确认完整概念图。只有 A03a 通过和两次视觉确认完成、FE 写入分支从最新集成点建立并收到新版本令牌后，FE-017 才能写入产品代码。
