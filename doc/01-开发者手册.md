...
- Future 的 6 方向 / 18 activity key 只登记到 catalog；本批没有 Future 页面、Bridge 或互动运行接线。V7.7.20 已确认 V7.7.19 的 hidden 分类仍受真实学生单元列表过滤边界阻断；BE-011 后端候选已形成，FE-012 接线与 Future A03b 继续等待后续实现。
