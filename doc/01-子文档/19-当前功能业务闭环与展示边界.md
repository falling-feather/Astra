...
> 最近更新：2026-08-28（V8.6.1 / UI-016）
> 更新者：DOC 组（主开发单线兼任）

集中保存 V8.0.34—V8.6.1 的集成状态、三角色业务闭环、学习空间完成层次与展示边界。V8.4 已闭合教师申请、建课审核、课程成员、共享草稿、不可变发布、三种完成结果和三角色工作台；V8.5 把这些既有事实整理为四项可见展示增强；V8.6.1 又完成主演示路径的作品化清理，均未增加数据库迁移或修改实验本体。
