...
> 最近更新：2026-08-28（V8.6.2 / BE-030）
> 更新者：DOC 组（主开发单线兼任）

集中保存 V8.0.34—V8.6.2 的集成状态、三角色业务闭环、学习空间完成层次与展示边界。V8.4 已闭合课程业务，V8.5 把既有事实整理为四项可见展示增强，V8.6.1 完成主演示清理，V8.6.2 再提供可解释课程健康只读聚合；上述版本均未修改实验本体。
