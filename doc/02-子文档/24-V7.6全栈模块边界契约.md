...
机器可读原件为 [`tools/architecture/v81-content-platform.json`](../../tools/architecture/v81-content-platform.json)，动态合同为 [`content-platform-architecture-contract.cjs`](../../tools/tests/content-platform-architecture-contract.cjs)。后续模型、迁移、接口和页面若与本节冲突，必须先修改 `ARCH-009` 任务和合同，不能在 Alembic 或 endpoint 中临时发明第二套关系。
...
4. [`content-platform-architecture-contract.cjs`](../../tools/tests/content-platform-architecture-contract.cjs) 能核对机器合同、本文和现有模型基线；
