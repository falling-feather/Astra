...
> **DOC-006 适用期校正**：本文保留首轮审查事实与当时提议，不再是当前实施方案原件。少数样板课程、机械臂探究课和 3D 代表实验优先的路线已撤换；完整业务规则与任务见 [02](../02-更新规划.md)，七组目标架构图见 [01 第 13 章](../01-开发者手册.md#13-目标架构与设计待实现)，撤换与交付记录见 [03 归档](../03-发布历史.md#6-规划替换与工作区交付归档)。
...
首轮后端回归和文档检查的结果现归档于 [39 号 C.2](../03-子文档/39-跨版本综述与规划迁移附录.md#c2-未提交工作区交付记录)。本轮未执行真实 MySQL、公网部署、Blender 建模、完整三角色真实浏览器旅程或真实课堂实验。上述“工作区交付”是首轮审查当时的状态。后续分任务提交和清理结果见 [03 第 7 节](../03-发布历史.md#7-2026-09-05-开发提交与工作区收尾)，未新增产品发布号；当前实施方案仍只认 02。
