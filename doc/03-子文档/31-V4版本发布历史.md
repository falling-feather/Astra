...
V4 主要完成五大学科实验扩充、首页与星系视觉升级、Canvas/移动端适配，以及早期内容质量修复。

---

## 本卷范围

- **版本范围**：V4.0.0（含可追溯记录）至 V5.0.0 之前
...
- 不动代码
- 同步修订 [99-历史审视报告归档.md §二B](../99-历史审视报告归档.md#a--ui-排版审视报告v405-基线)，把这 4 项标注为误报关闭
...
详见 [doc/99-历史审视报告归档.md](../99-历史审视报告归档.md#b--移动端适配审视报告v411-基线)。摘要：
