...
- **当时基准**：历史 `muban/README.md`（V7.6.9 已删除，仍可由 Git 历史与 `archive/qianduan-wip-before-main-sync-20260727` 恢复）+ [doc/05-UI规范模板.md](05-UI规范模板.md)
...
- [16-界面样式、移动端与无障碍](01-子文档/16-界面样式移动端与无障碍.md#125-移动端开发规范v421-新增) — §12.5 移动端排版规范
