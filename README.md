...
- 当前统一开发基线为 `main`，包含 V8.6.6、课程学习统计与单元发布计划修复，以及已确认的新方案文档。本轮采用普通开发提交，未新增产品发布号；提交与验证见 [收尾记录](doc/03-发布历史.md#7-2026-09-05-开发提交与工作区收尾)。
...
- Alembic 当前唯一 head 为 `20260825_0058`。最新提交验证见 [收尾记录](doc/03-发布历史.md#7-2026-09-05-开发提交与工作区收尾)，历史验收见 [发布历史](doc/03-发布历史.md)。隔离 runner、生产部署和真实课堂实证仍不在当前完成口径内。
