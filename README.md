...
- 当前文档控制基线为 `主开发@V8.0.37`；产品运行字节仍以 V8.0.34 为未完成同版本浏览器终验的展示候选。`main`、`houduan`、`review` 和历史任务分支只作发布/审计锚点，不是当前开发入口。
...
| [`doc/02-更新规划.md`](doc/02-更新规划.md) | V8.1—V8.6 中版本、小版本、T0/T1/T2 与长期方向 |
